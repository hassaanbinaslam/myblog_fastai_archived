...
<div class="cell border-box-sizing text_cell rendered"><div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<h2 id="Introduction">Introduction<a class="anchor-link" href="#Introduction"> </a></h2><p>In this notebook, we will train a linear regression model using PyTorch. Given below is the summary of the steps followed in this notebook.</p>
<ul>
...
<div class="cell border-box-sizing text_cell rendered"><div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<h2 id="Generate-synthetic-linear-data">Generate synthetic linear data<a class="anchor-link" href="#Generate-synthetic-linear-data"> </a></h2><p>In this section, we will generate some data representing a line using equation "y = mx + b". 
<code>y = mx + b</code> is the slope intercept form of writing the equation of a straight line. In the equation 'b' is the point where the line intersects the 'y axis' and 'm' denotes the slope of the line. If you want to read more about this equation then follow this post: <a href="https://www.cuemath.com/geometry/y-mx-b/">cuemath.com/geometry/y-mx-b</a></p>
...
<span class="k">def</span> <span class="nf">generate_linear_data</span><span class="p">(</span><span class="n">n_data_points</span><span class="o">=</span><span class="mi">100</span><span class="p">,</span> <span class="n">true_m</span><span class="o">=</span><span class="mi">1</span><span class="p">,</span> <span class="n">true_b</span><span class="o">=</span><span class="mi">1</span><span class="p">):</span>
    <span class="sd">&quot;&quot;&quot;</span>
<span class="sd">    Generate linear data using equation: y = mx + b + e</span>
<span class="sd">    where &#39;e&#39; is some random noise added</span>
<span class="sd">    &quot;&quot;&quot;</span>
...
<span class="c1"># Let&#39;s generate 100 data points</span>
<span class="n">n_data_points</span> <span class="o">=</span> <span class="mi">100</span>
<span class="n">true_m</span> <span class="o">=</span> <span class="mi">2</span> <span class="c1"># this is &#39;m&#39; from slope-intercept line equation</span>
<span class="n">true_b</span> <span class="o">=</span> <span class="mi">1</span> <span class="c1"># this is &#39;b&#39; from slope-intercept line equation</span>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="c1"># Convert NumPy array to PyTorch tensors</span>
...
<span class="c1"># Performs the 80-20% train-valid split</span>
...
<span class="c1"># Use batch_size = 16 as data size is small</span>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="c1"># Visualize training and validation data</span>

<span class="c1"># extrat train and validation sets from DataLoader as a list of tuples</span>
...
<span class="c1"># get data and labels (x, y) from extracted tuples list</span>
...
<div class="cell border-box-sizing text_cell rendered"><div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<h2 id="Create-model-configuration">Create model configuration<a class="anchor-link" href="#Create-model-configuration"> </a></h2><p>In this section, we will configure the linear model for training, define a loss function, and an optimizer to update the weights.</p>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="c1"># Model configuration</span>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="c1"># model weights before training</span>
...
<div class="cell border-box-sizing text_cell rendered"><div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<h2 id="Define-training,-validation-and-mini-batch-processing-pipeline">Define training, validation and mini-batch processing pipeline<a class="anchor-link" href="#Define-training,-validation-and-mini-batch-processing-pipeline"> </a></h2><p>In this section, we will define our pipelines for training and validation.</p>
<ul>
<li><p>Training pipeline is usually called "training step" which includes the following steps</p>
<ol>
...
<li><p>Validation pipeline is usually called the "validation step" which includes the following steps</p>
<ol>
<li>Computes our model's predicted output - the forward pass</li>
<li>Computes the loss</li>
</ol>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="c1"># Training pipeline - training step</span>

<span class="c1"># helper function for training</span>
<span class="k">def</span> <span class="nf">make_train_step_fn</span><span class="p">(</span><span class="n">model</span><span class="p">,</span> <span class="n">loss_fn</span><span class="p">,</span> <span class="n">optimizer</span><span class="p">):</span>
    ...
    <span class="k">def</span> <span class="nf">perform_train_step_fn</span><span class="p">(</span><span class="n">x</span><span class="p">,</span> <span class="n">y</span><span class="p">):</span>
        ...
        <span class="c1"># Step 3 - Computes gradients</span>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="c1"># Validation pipeline - validation step.</span>

<span class="c1"># helper function for validation</span>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="c1"># Helper function for minibatch processing</span>
...
<div class="cell border-box-sizing text_cell rendered"><div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<h2 id="Configure-TensorBoard-to-visualize-loss-logs">Configure TensorBoard to visualize loss logs<a class="anchor-link" href="#Configure-TensorBoard-to-visualize-loss-logs"> </a></h2><p>In this section we will configure TensorBoard to track and visualize training and validation loss.</p>
...
<div class="cell border-box-sizing text_cell rendered"><div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<h2 id="Execute-model-training-and-validation-pipeline">Execute model training and validation pipeline<a class="anchor-link" href="#Execute-model-training-and-validation-pipeline"> </a></h2><p>Now we are ready to execute our training pipeline. We will train our model for 200 epochs. An epoch is one cycle when the model has seen all the training data to compute loss, and we want our model to do it 200 times (200 epochs).</p>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="c1"># Execute pipeline with training and validation steps</span>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="c1"># model weights after training</span>
<span class="nb">print</span><span class="p">(</span><span class="n">model</span><span class="o">.</span><span class="n">state_dict</span><span class="p">())</span>
</pre></div>
...
<div class="cell border-box-sizing text_cell rendered"><div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<h2 id="Visualize-loss-logs-from-TensorBoard">Visualize loss logs from TensorBoard<a class="anchor-link" href="#Visualize-loss-logs-from-TensorBoard"> </a></h2><p>Let's view how our training and validation loss has progressed throughout the training using TensorBoard.</p>
...
<div class="cell border-box-sizing text_cell rendered"><div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p><img src="/myblog/images/copied_from_nb/images/2022-10-10-pytorch-linear-regression/tensorboard.PNG" alt="tensorboard.PNG"></p>
...
<div class="cell border-box-sizing text_cell rendered"><div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<h1 id="Comparison-with-Scikit-Learn-LinearRegression-model">Comparison with Scikit-Learn LinearRegression model<a class="anchor-link" href="#Comparison-with-Scikit-Learn-LinearRegression-model"> </a></h1><p>Let's also make a quick comparison with sklearn LinearRegression model to see how our Neural Net model stands against it.</p>
